    ...
    <div>
      ...
      <div className="w-2/3 p-8 mx-auto">
        ...
        <p className="mt-6 leading-7 font-semibold w-2/3 mx-auto">
          ...
          perspiciatis nihil nesciunt est dolor, tenetur minus a debitis cumque
          in velit! Perspiciatis doloremque, aliquam deserunt necessitatibus
          deleniti at explicabo suscipit eveniet nostrum temporibus, rem
          asperiores veritatis in dicta illum?{" "}
        </p>
      </div>
      ...
      <div className="w-2/3 mx-auto my-12">
        <p className="w-4/5 text-sm mx-auto">
          <LongParagraphComponent text={longText} />
        </p>
      </div>
    </div>
  );
