  ...
  return (
    <div className='h-60 flex py-3 bg-stone-100 justify-center items-center'>
       ...
       <h1 className='text-5xl font-bold text-stone-700'>Study Abroad</h1>
        ...
        <button onClick={()=>navigate(`${token ? '/profile' :'/enquiry'}`)} className='px-3 text-xs  capitalize border border-stone-700 hover:text-white hover:border-blue-400 rounded-md h-8 text-stone-900 outline-none hover:bg-blue-400'>Enquire now</button>
        </div>
       </div>
    </div>
  )
