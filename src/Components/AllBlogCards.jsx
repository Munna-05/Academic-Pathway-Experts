        ...
        <div className="w-3/4 mx-auto ">
          ...
          <div className="flex  justify-center items-center py-20">
            ...
            <div className="px-8 relative items text-left">
              ...
              <p className="w-3/4 text-stone-500 text-sm mt-2">Nihil ea sunt facilis praesentium atque. Ab animi alias sequi molestias aut velit ea. Sed possimus eos. Et est aliquid est voluptatem.</p>

              <div className="absolute bottom-0 py-2 flex items-center gap-6  w-96">
                ...
                <div className="text-sm font-semibold  text-stone-700">Auther Name</div>
              </div>
